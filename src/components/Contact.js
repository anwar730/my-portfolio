    ...
    <section id="contact" className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-600">Have a project in mind? Let's work together!</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/2">
            ...
            <form className="space-y-6" action="https://formspree.io/f/xnndazbl" method="POST">
  <div>
    <label htmlFor="name" className="block text-gray-700 mb-1">Name</label>
    <input
      type="text"
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex space-x-4 mt-2">
                    <a href="https://github.com/anwar730" target="blank" className="text-gray-700 hover:text-indigo-600">
                      <Github size={24} />
                    </a>
                    <a href="https://www.linkedin.com/in/
anwar-ismail-a5502124b/" target="blank" className="text-gray-700 hover:text-indigo-600">
                      <Linkedin size={24} />
                    </a>
                  </div>
                </div>
